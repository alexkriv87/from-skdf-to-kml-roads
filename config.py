...
# ============= СООТВЕТСТВИЕ КАТЕГОРИЙ И ПЛЕЙСХОЛДЕРОВ =============
...
DESCRIPTION_TEMPLATE = [
    ...
    "Ширина:",                # краткий диапазон ширины
    "Участки ширины:",        # детальные участки ширины
    "Осевая нагрузка:",       # краткий диапазон нагрузки
    "Участки нагрузки:",      # детальные участки нагрузки
]
